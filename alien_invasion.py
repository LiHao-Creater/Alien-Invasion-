"""Main game module for Alien Invasion"""
import sys
import random
...
class AlienInvasion:
    ...
    def _check_keydown_events(self, event):
        ...
        if event.key == pygame.K_RIGHT:
            ...
            if not self.stats.game_active:
                self._check_play_button((self.play_button.rect.centerx,
                                        self.play_button.rect.centery))
    ...
    def _update_alien_bullets(self):
        ...
        # Check for alien bullets hitting shields.
        for shield in self.shields:
            shield.check_collision_with_bullet(self.alien_bullets)
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Check for bullets hitting shields.
        for shield in self.shields:
            shield.check_collision_with_bullet(self.bullets)
    ...
    def _update_aliens(self):
        ...
        for alien in self.aliens.sprites():
            if random.random() < self.settings.alien_shoot_frequency:
    ...
    def _create_shields(self):
        """Create shields for protection."""
        self.shields = []
        shield_y = self.settings.screen_height - 150
        num_shields = self.settings.shield_blocks
        shield_spacing = self.settings.screen_width // (num_shields + 1)

        for i in range(num_shields):
            shield_x = shield_spacing * (i + 1) - self.settings.shield_width // 2
